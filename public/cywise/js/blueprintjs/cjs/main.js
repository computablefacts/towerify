...
var table = require('@blueprintjs/table');
...
blueprintjs.Blueprintjs = class extends widgets.Widget {
  ...
  render() {
    const element = this._newElement();
    if (element) {
      ReactDOM__default["default"].render(element, this.container);
    }
  }
...
blueprintjs.MinimalTable = class extends blueprintjs.Blueprintjs {
  ...
  _newCell(self, rowIdx, colIdx) {
    return self.cellRenderer_ ? self.cellRenderer_(rowIdx, colIdx, self.rows[rowIdx][colIdx]) : React__default["default"].createElement(
      table.Cell, {
        rowIndex: rowIdx, columnIndex: colIdx, style: {
          'text-align': self.columnTypes[colIdx] === 'number' ? 'right' : 'left'
        }, children: React__default["default"].createElement('div', {}, self.rows[rowIdx][colIdx]),
      });
  }

  _newColumnHeader(self, column) {
    return React__default["default"].createElement(table.ColumnHeaderCell, {
      name: column, menuRenderer: () => {

        // Menu item for sorting the column in ascending order
        const menuItemSortAsc = React__default["default"].createElement(core.MenuItem, {
        ...
        const menuItemSortDesc = React__default["default"].createElement(core.MenuItem, {
          icon: 'sort-desc', text: 'Sort Desc', onClick: () => self.observers_.notify('sort', column, 'DESC'),
        });

        return React__default["default"].createElement(core.Menu, {
  ...
  _newColumn(self, column) {
    return React__default["default"].createElement(table.Column, {
      name: column,
  ...
  _newElement() {
    return React__default["default"].createElement(table.Table2, {
      ...
      onColumnsReordered: (oldIndex, newIndex, length) => {
        ...
        this.loadingOptions = [table.TableLoadingOption.CELLS];
...
blueprintjs.MinimalSelect = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(select.Select2, {
      fill: this.fillContainer,
      disabled: this.disabled,
      ...
      noResults: React__default["default"].createElement(core.MenuItem, {
...
blueprintjs.MinimalSlider = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(core.Slider, {
      min: this.min_,
      max: this.max_,
...
blueprintjs.MinimalRangeSlider = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(core.RangeSlider, {
      min: this.min_,
      max: this.max_,
      stepSize: this.increment_,
      labelStepSize: this.displayIncrement_,
...
blueprintjs.MinimalDrawer = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(core.Drawer, {
      isOpen: this.show,
      size: this.width_,
      position: core.Position.RIGHT,
...
blueprintjs.MinimalTabs = class extends blueprintjs.Blueprintjs {
  ...
  _newTab(tab) {
    return React__default["default"].createElement(core.Tab, {
  ...
  _newElement() {
    ...
    return React__default["default"].createElement(core.Tabs, {
      id: 'tabs',
...
blueprintjs.MinimalSpinner = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, size) {
    ...
    this.value_ = null;
    if (size === 'small') {
      this.size_ = core.SpinnerSize.SMALL;
    } else if (size === 'large') {
      this.size_ = core.SpinnerSize.LARGE;
    } else {
      this.size_ = core.SpinnerSize.STANDARD;
    }
    this.render();
  }
  ...
  _newElement() {
    return React__default["default"].createElement(core.Spinner, {
...
blueprintjs.MinimalSwitch = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, checked, label, labelPosition, labelChecked, labelUnchecked) {
    ...
    this.label_ = label;
    this.switchPosition_ = labelPosition === 'left' ? core.Alignment.RIGHT : core.Alignment.LEFT;
  ...
  _newElement() {
    return React__default["default"].createElement(core.Switch, {
...
blueprintjs.MinimalToast = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, message, intent, timeout) {
    ...
    if (intent === 'primary') {
      this.intent_ = core.Intent.PRIMARY;
      this.icon_ = null;
    } else if (intent === 'success') {
      this.intent_ = core.Intent.SUCCESS;
      this.icon_ = 'tick';
    } else if (intent === 'warning') {
      this.intent_ = core.Intent.WARNING;
      this.icon_ = 'warning-sign';
    } else if (intent === 'danger') {
      this.intent_ = core.Intent.DANGER;
      this.icon_ = 'warning-sign';
    } else {
      this.intent_ = core.Intent.NONE;
      this.icon_ = null;
    }
    this.observers_ = new observers.Subject();
    this.render();
  ...
  _newElement() {
    return React__default["default"].createElement(core.Toast, {
      intent: this.intent_,
      icon: this.icon_,
      message: React__default["default"].createElement('div', {}, this.message_),
...
blueprintjs.MinimalToaster = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(core.Toaster, {
      children: this.toasts_.map(toast => toast.el_), position: core.Position.TOP,
    });
  }
};
...
blueprintjs.MinimalCard = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, body) {
    ...
    this.observers_ = new observers.Subject();
    this.body_ = React__default["default"].createElement('div', {
  ...
  _newElement() {
    return React__default["default"].createElement(core.Card, {
      children: [this.body_],
...
blueprintjs.MinimalCheckbox = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, checked, label, labelPosition) {
    ...
    this.checked_ = checked;
    this.label_ = label;
    this.boxPosition_ = labelPosition === 'left' ? core.Alignment.RIGHT : core.Alignment.LEFT;
    this.disabled_ = false;
    this.render();
  }
  ...
  _newElement() {
    return React__default["default"].createElement(core.Checkbox, {
      checked: this.checked_,
      disabled: this.disabled_,
      label: this.label_,
...
blueprintjs.MinimalDate = class extends blueprintjs.Blueprintjs {
  ...
  constructor(container, format, minDate, maxDate) {
    ...
    this.minDate_ = minDate ? minDate : dateFns.sub(new Date(), {years: 10});
    this.maxDate_ = maxDate ? maxDate : dateFns.add(new Date(), {years: 10});
    this.render();
  }
  ...
  _newElement() {
    return React__default["default"].createElement(datetime2.DateInput2, {
      formatDate: (date) => dateFns.format(date, this.format_),
      parseDate: (str) => dateFns.parse(str, this.format_, new Date()),
      value: this.date,
      disabled: this.disabled,
...
blueprintjs.MinimalDatetime = class extends blueprintjs.MinimalDate {
  ...
  constructor(container, format, minDate, maxDate, timePrecision, defaultTimezone) {
    ...
    this.timePrecision_ = timePrecision === 'hours' ? datetime.TimePrecision.HOUR_24 : timePrecision === 'seconds'
      ? datetime.TimePrecision.SECOND : datetime.TimePrecision.MINUTE;
...
blueprintjs.MinimalDateRange = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(datetime2.DateRangeInput2, {
      formatDate: (date) => dateFns.format(date, this.format_),
      parseDate: (str) => dateFns.parse(str, this.format_, new Date()),
...
blueprintjs.MinimalMultiSelect = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(select.MultiSelect2, {
      fill: this.fillContainer,
      disabled: this.disabled,
      items: this.items,
...
blueprintjs.MinimalSuggest = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(select.Suggest2, {
      fill: this.fillContainer,
      disabled: this.disabled,
      items: this.items,
...
blueprintjs.MinimalRadioGroup = class extends blueprintjs.Blueprintjs {
  ...
  _newElement() {
    return React__default["default"].createElement(core.RadioGroup, {
      label: this.label_,
      inline: this.inline_,
      disabled: this.disabled,
      options: this.items,
