    ...
    <div class="col-md-8 col-lg-6">
        ...
        <x-appshell::card tag="form" method="POST" action="{{ route('appshell.public.invitation.accept') }}">
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-6">
                    <input id="password-confirm" placeholder="{{ __('uppercase/lowercase letters and digits only') }}" type="password" class="form-control" name="password_confirmation" required>
                </div>
            </div>
            <x-slot:footer>
                <div class="d-grid">
